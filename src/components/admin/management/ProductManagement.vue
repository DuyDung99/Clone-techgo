    ...
    <div class="product-management">
        <div class="management-box">
            <div class="product-header">
                <span>Pages / ProductManagement</span>
                <div>
                    <SettingAdm></SettingAdm>
                </div>
            </div>
...
import SettingAdm from '../share/Setting-component.vue';
import AddProductAdm from '../share/AddProduct-component.vue';
export default {
    components: {
        SettingAdm,
        AddProductAdm
