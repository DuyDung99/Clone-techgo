                        ...
                        <div class="table-cart">
                            <div class="media-items">
                                <div class="media-items-img">
                                    <a href=""><img :src="data.thumnail_image_links[0]" alt=""></a>
                                ...
                                <div class="media-items-price-detail">
                                    <p>{{ data.name }}</p>
                                    <p>
                                        <span class="items-span">{{ onDiscount(data) }}</span>
                                        <span class="items-span" :class="[data.sale > 0 ? 'items-underlined' : '']">{{
                                            formatOldPrice(data)
                                        }}</span>
                                    </p>
                                </div>
                                <div class="media-items-price-pay">
                                    ...
                                    <div class="btn">
                                        ...
                                        <p>{{ numberCart }}</p>
                                        <button @click="onClickPlus(data)"><i class="fa-solid fa-plus"></i></button>
                                    </div>
                                </div>
                            </div>
                            <!-- ---------------------------------------------------------------- -->
                        ...
                        <div class="block-items">
                            <div class="Content-right-pay">
                                ...
                                <div class="Content-right-price">
                                    <span>Tổng Tiền:</span>
                                    <span class="Content-right-span">{{ onDiscount(data) }}</span>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        onClickPlus(data) {
            ...
            this.price = this.onDiscount(data) * this.numberCart
            console.log(this.price = this.onDiscount(data) * this.numberCart);
            console.log(this.onDiscount(data));
        },
    }
}
</script>
